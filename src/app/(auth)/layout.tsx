export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-sidebar px-4">
      {/* Ambient structural depth - soft glow top, accent whisper bottom */}
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-1/4 left-1/2 h-[360px] w-[360px] -translate-x-1/2 rounded-full bg-tint/10 blur-[120px]"
      />
