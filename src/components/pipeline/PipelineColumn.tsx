...
export function PipelineColumn({ stage }: { stage: PipelineStage }) {
  return (
    <div className="flex w-[80vw] max-w-72 shrink-0 flex-col rounded-md bg-soft sm:w-72">
      <Link
      ...
      <div className="flex-1 space-y-2 overflow-y-auto px-2 pb-3">
        {stage.leads.length === 0 ? (
          <p className="px-1 py-4 text-center text-caption text-ink-secondary">No leads</p>
        ) : (
